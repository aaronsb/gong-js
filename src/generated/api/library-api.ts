...
// @ts-ignore
import type { LibraryFolderListOfCallsResponse } from '../models';
// @ts-ignore
import type { LibraryResponse } from '../models';
/**
...
export const LibraryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [folderId] Gong\&#39;s unique numeric identifier for the folder (up to 20 digits).
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getCallsInSpecificFolder: async (folderId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/library/folder-content`;
         ...
         * @param {string} [workspaceId] Workspace identifier. We will retrieve folders which are related to this specific workspace.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getLibraryStructure: async (workspaceId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/library/folders`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const LibraryApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getCallsInSpecificFolder(folderId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LibraryFolderListOfCallsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCallsInSpecificFolder(folderId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['LibraryApi.getCallsInSpecificFolder']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getLibraryStructure(workspaceId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LibraryResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getLibraryStructure(workspaceId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['LibraryApi.getLibraryStructure']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const LibraryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Given a folder id, this endpoint retrieves a list of calls in it.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:library:read\'.
         * @summary List of calls in a specific folder (/v2/library/folder-content)
         * @param {LibraryApiGetCallsInSpecificFolderRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getCallsInSpecificFolder(requestParameters: LibraryApiGetCallsInSpecificFolderRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<LibraryFolderListOfCallsResponse> {
            return localVarFp.getCallsInSpecificFolder(requestParameters.folderId, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve a list of public library folders. We do not allow retrieval of either private or archived folders.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:library:read\'.
         * @summary Retrieve Library folders (/v2/library/folders)
         * @param {LibraryApiGetLibraryStructureRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getLibraryStructure(requestParameters: LibraryApiGetLibraryStructureRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<LibraryResponse> {
            return localVarFp.getLibraryStructure(requestParameters.workspaceId, options).then((request) => request(axios, basePath));
        },
    };
};
...
/**
 * Request parameters for getCallsInSpecificFolder operation in LibraryApi.
 * @export
 * @interface LibraryApiGetCallsInSpecificFolderRequest
 */
export interface LibraryApiGetCallsInSpecificFolderRequest {
    /**
     * Gong\&#39;s unique numeric identifier for the folder (up to 20 digits).
     * @type {string}
     * @memberof LibraryApiGetCallsInSpecificFolder
     */
    readonly folderId?: string
}

/**
 * Request parameters for getLibraryStructure operation in LibraryApi.
 * @export
 * @interface LibraryApiGetLibraryStructureRequest
 */
export interface LibraryApiGetLibraryStructureRequest {
    /**
     * Workspace identifier. We will retrieve folders which are related to this specific workspace.
     * @type {string}
     * @memberof LibraryApiGetLibraryStructure
     */
...
export class LibraryApi extends BaseAPI implements LibraryApiInterface {
     ...
     * @memberof LibraryApi
     */
    public getCallsInSpecificFolder(requestParameters: LibraryApiGetCallsInSpecificFolderRequest = {}, options?: RawAxiosRequestConfig) {
        return LibraryApiFp(this.configuration).getCallsInSpecificFolder(requestParameters.folderId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LibraryApi
     */
    public getLibraryStructure(requestParameters: LibraryApiGetLibraryStructureRequest = {}, options?: RawAxiosRequestConfig) {
        return LibraryApiFp(this.configuration).getLibraryStructure(requestParameters.workspaceId, options).then((request) => request(this.axios, this.basePath));
    }
}
