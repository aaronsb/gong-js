...
export const DataPrivacyApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        findAllReferencesToEmailAddress: async (emailAddress: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        findAllReferencesToPhoneNumber: async (phoneNumber: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        purgeEmailAddress: async (emailAddress: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'emailAddress' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        purgePhoneNumber: async (phoneNumber: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'phoneNumber' is not null or undefined
...
export const DataPrivacyApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async findAllReferencesToEmailAddress(emailAddress: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EmailAddressReferences>> {
         ...
         * @throws {RequiredError}
         */
        async findAllReferencesToPhoneNumber(phoneNumber: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PhoneNumberReferences>> {
         ...
         * @throws {RequiredError}
         */
        async purgeEmailAddress(emailAddress: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseResponse>> {
         ...
         * @throws {RequiredError}
         */
        async purgePhoneNumber(phoneNumber: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseResponse>> {
 ...
 * @extends {BaseAPI}
 */
export class DataPrivacyApi extends BaseAPI implements DataPrivacyApiInterface {
    /**
     * Shows the elements in the Gong system that reference the given email address. Given an emails address, this endpoint returns details of all calls and email messages that reference this address, and any leads or contacts with this email address.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:data-privacy:read\'.
     * @summary Retrieve all references to an email address. (/v2/data-privacy/data-for-email-address)
     * @param {DataPrivacyApiFindAllReferencesToEmailAddressRequest} requestParameters Request parameters.
     ...
     */
    public findAllReferencesToEmailAddress(requestParameters: DataPrivacyApiFindAllReferencesToEmailAddressRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof DataPrivacyApi
     */
    public findAllReferencesToPhoneNumber(requestParameters: DataPrivacyApiFindAllReferencesToPhoneNumberRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof DataPrivacyApi
     */
    public purgeEmailAddress(requestParameters: DataPrivacyApiPurgeEmailAddressRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof DataPrivacyApi
     */
    public purgePhoneNumber(requestParameters: DataPrivacyApiPurgePhoneNumberRequest, options?: RawAxiosRequestConfig) {
