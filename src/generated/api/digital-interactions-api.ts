...
// @ts-ignore
import type { DigitalInteractionRequest } from '../models';
// @ts-ignore
import type { ErrorResponse } from '../models';
// @ts-ignore
import type { EventAcceptedResponse } from '../models';
/**
 * DigitalInteractionsApi - axios parameter creator
 * @export
 */
export const DigitalInteractionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @param {DigitalInteractionRequest} digitalInteractionRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        addDigitalInteraction: async (digitalInteractionRequest: DigitalInteractionRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'digitalInteractionRequest' is not null or undefined
            assertParamExists('addDigitalInteraction', 'digitalInteractionRequest', digitalInteractionRequest)
            const localVarPath = `/v2/digital-interaction`;
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(digitalInteractionRequest, localVarRequestOptions, configuration)
...
/**
 * DigitalInteractionsApi - functional programming interface
 * @export
 */
export const DigitalInteractionsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = DigitalInteractionsApiAxiosParamCreator(configuration)
    return {
        /**
         * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:digital-interactions:write\'.
         * @summary Post a Digital Interaction (/v2/digital-interaction)
         ...
         * @throws {RequiredError}
         */
        async addDigitalInteraction(digitalInteractionRequest: DigitalInteractionRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EventAcceptedResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addDigitalInteraction(digitalInteractionRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DigitalInteractionsApi.addDigitalInteraction']?.[localVarOperationServerIndex]?.url;
...
/**
 * DigitalInteractionsApi - factory interface
 * @export
 */
export const DigitalInteractionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = DigitalInteractionsApiFp(configuration)
    return {
        /**
         * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:digital-interactions:write\'.
         * @summary Post a Digital Interaction (/v2/digital-interaction)
         * @param {DigitalInteractionsApiAddDigitalInteractionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        addDigitalInteraction(requestParameters: DigitalInteractionsApiAddDigitalInteractionRequest, options?: RawAxiosRequestConfig): AxiosPromise<EventAcceptedResponse> {
            return localVarFp.addDigitalInteraction(requestParameters.digitalInteractionRequest, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * DigitalInteractionsApi - interface
 * @export
 * @interface DigitalInteractionsApi
 */
export interface DigitalInteractionsApiInterface {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:digital-interactions:write\'.
     * @summary Post a Digital Interaction (/v2/digital-interaction)
     * @param {DigitalInteractionsApiAddDigitalInteractionRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DigitalInteractionsApiInterface
     */
    addDigitalInteraction(requestParameters: DigitalInteractionsApiAddDigitalInteractionRequest, options?: RawAxiosRequestConfig): AxiosPromise<EventAcceptedResponse>;
...
/**
 * Request parameters for addDigitalInteraction operation in DigitalInteractionsApi.
 * @export
 * @interface DigitalInteractionsApiAddDigitalInteractionRequest
 */
export interface DigitalInteractionsApiAddDigitalInteractionRequest {
    /**
     * 
     * @type {DigitalInteractionRequest}
     * @memberof DigitalInteractionsApiAddDigitalInteraction
     */
    readonly digitalInteractionRequest: DigitalInteractionRequest
}

/**
 * DigitalInteractionsApi - object-oriented interface
 * @export
 * @class DigitalInteractionsApi
 * @extends {BaseAPI}
 */
export class DigitalInteractionsApi extends BaseAPI implements DigitalInteractionsApiInterface {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:digital-interactions:write\'.
     * @summary Post a Digital Interaction (/v2/digital-interaction)
     * @param {DigitalInteractionsApiAddDigitalInteractionRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DigitalInteractionsApi
     */
    public addDigitalInteraction(requestParameters: DigitalInteractionsApiAddDigitalInteractionRequest, options?: RawAxiosRequestConfig) {
        return DigitalInteractionsApiFp(this.configuration).addDigitalInteraction(requestParameters.digitalInteractionRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
