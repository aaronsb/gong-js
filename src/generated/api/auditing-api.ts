...
/**
 * AuditingApi - axios parameter creator
 * @export
 */
export const AuditingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @param {ListLogsLogTypeEnum} logType Type of logs requested.
         * @param {string} fromDateTime The time from which to retrieve log records, in the ISO-8601 format (e.g., \&#39;2018-02-18T02:30:00-07:00\&#39; or \&#39;2018-02-18T08:00:00Z\&#39;, where Z stands for UTC).
         * @param {string} [toDateTime] The time until which to retrieve log records, in the ISO-8601 format (e.g., \&#39;2018-02-18T02:30:00-07:00\&#39; or \&#39;2018-02-18T08:00:00Z\&#39;, where Z stands for UTC); if not specified, the logs end with the latest recorded log.
         ...
         */
        listLogs: async (logType: ListLogsLogTypeEnum, fromDateTime: string, toDateTime?: string, cursor?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('listLogs', 'fromDateTime', fromDateTime)
...
/**
 * AuditingApi - functional programming interface
 * @export
 */
export const AuditingApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = AuditingApiAxiosParamCreator(configuration)
    return {
        /**
         * List log entries that took place during a specified time range.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:logs:read\'.
         * @summary Retrieve logs data by type and time range (/v2/logs)
         ...
         * @throws {RequiredError}
         */
        async listLogs(logType: ListLogsLogTypeEnum, fromDateTime: string, toDateTime?: string, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LogsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listLogs(logType, fromDateTime, toDateTime, cursor, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AuditingApi.listLogs']?.[localVarOperationServerIndex]?.url;
...
/**
 * AuditingApi - factory interface
 * @export
 */
export const AuditingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = AuditingApiFp(configuration)
    return {
        /**
         * List log entries that took place during a specified time range.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:logs:read\'.
         * @summary Retrieve logs data by type and time range (/v2/logs)
         * @param {AuditingApiListLogsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listLogs(requestParameters: AuditingApiListLogsRequest, options?: RawAxiosRequestConfig): AxiosPromise<LogsResponse> {
            return localVarFp.listLogs(requestParameters.logType, requestParameters.fromDateTime, requestParameters.toDateTime, requestParameters.cursor, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * AuditingApi - interface
 * @export
 * @interface AuditingApi
 */
export interface AuditingApiInterface {
    /**
     * List log entries that took place during a specified time range.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:logs:read\'.
     * @summary Retrieve logs data by type and time range (/v2/logs)
     * @param {AuditingApiListLogsRequest} requestParameters Request parameters.
...
/**
 * Request parameters for listLogs operation in AuditingApi.
 * @export
 * @interface AuditingApiListLogsRequest
 */
export interface AuditingApiListLogsRequest {
    /**
     * Type of logs requested.
     * @type {'AccessLog' | 'UserActivityLog' | 'UserCallPlay' | 'ExternallySharedCallAccess' | 'ExternallySharedCallPlay'}
     * @memberof AuditingApiListLogs
     */
    readonly logType: ListLogsLogTypeEnum
...
/**
 * AuditingApi - object-oriented interface
 * @export
 * @class AuditingApi
 * @extends {BaseAPI}
 */
export class AuditingApi extends BaseAPI implements AuditingApiInterface {
    /**
     * List log entries that took place during a specified time range.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:logs:read\'.
     * @summary Retrieve logs data by type and time range (/v2/logs)
     * @param {AuditingApiListLogsRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof AuditingApi
     */
    public listLogs(requestParameters: AuditingApiListLogsRequest, options?: RawAxiosRequestConfig) {
        return AuditingApiFp(this.configuration).listLogs(requestParameters.logType, requestParameters.fromDateTime, requestParameters.toDateTime, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
}
 ...
 * @export
 */
export const ListLogsLogTypeEnum = {
    ACCESS_LOG: 'AccessLog',
    USER_ACTIVITY_LOG: 'UserActivityLog',
    USER_CALL_PLAY: 'UserCallPlay',
    EXTERNALLY_SHARED_CALL_ACCESS: 'ExternallySharedCallAccess',
    EXTERNALLY_SHARED_CALL_PLAY: 'ExternallySharedCallPlay'
} as const;
export type ListLogsLogTypeEnum = typeof ListLogsLogTypeEnum[keyof typeof ListLogsLogTypeEnum];
