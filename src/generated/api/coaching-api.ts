 ...
 * @export
 */
export const CoachingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
 ...
 * @export
 */
export const CoachingApiFp = function(configuration?: Configuration) {
 ...
 * @export
 */
export const CoachingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
 ...
 * @extends {BaseAPI}
 */
export class CoachingApi extends BaseAPI implements CoachingApiInterface {
    /**
     * List all of the coaching metrics of a manager.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:coaching:read\'.
     * @summary List all coaching metrics (/v2/coaching)
     * @param {CoachingApiListUsers1Request} requestParameters Request parameters.
