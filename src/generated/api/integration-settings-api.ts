...
// @ts-ignore
import type { IntegrationSettingsRequest } from '../models';
// @ts-ignore
import type { RegisterGenericCrmResponse } from '../models';
/**
 * IntegrationSettingsApi - axios parameter creator
 * @export
 */
export const IntegrationSettingsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @param {IntegrationSettingsRequest} integrationSettingsRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        integrationSettings: async (integrationSettingsRequest: IntegrationSettingsRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'integrationSettingsRequest' is not null or undefined
            assertParamExists('integrationSettings', 'integrationSettingsRequest', integrationSettingsRequest)
            const localVarPath = `/v2/integration-settings`;
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(integrationSettingsRequest, localVarRequestOptions, configuration)
...
/**
 * IntegrationSettingsApi - functional programming interface
 * @export
 */
export const IntegrationSettingsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = IntegrationSettingsApiAxiosParamCreator(configuration)
    return {
        /**
         * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:integration-settings:write\'.
         * @summary Integration Settings (/v2/integration-settings)
         ...
         * @throws {RequiredError}
         */
        async integrationSettings(integrationSettingsRequest: IntegrationSettingsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegisterGenericCrmResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.integrationSettings(integrationSettingsRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['IntegrationSettingsApi.integrationSettings']?.[localVarOperationServerIndex]?.url;
...
/**
 * IntegrationSettingsApi - factory interface
 * @export
 */
export const IntegrationSettingsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = IntegrationSettingsApiFp(configuration)
    return {
        /**
         * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:integration-settings:write\'.
         * @summary Integration Settings (/v2/integration-settings)
         * @param {IntegrationSettingsApiIntegrationSettingsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        integrationSettings(requestParameters: IntegrationSettingsApiIntegrationSettingsRequest, options?: RawAxiosRequestConfig): AxiosPromise<RegisterGenericCrmResponse> {
            return localVarFp.integrationSettings(requestParameters.integrationSettingsRequest, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * IntegrationSettingsApi - interface
 * @export
 * @interface IntegrationSettingsApi
 */
export interface IntegrationSettingsApiInterface {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:integration-settings:write\'.
     * @summary Integration Settings (/v2/integration-settings)
     * @param {IntegrationSettingsApiIntegrationSettingsRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof IntegrationSettingsApiInterface
     */
    integrationSettings(requestParameters: IntegrationSettingsApiIntegrationSettingsRequest, options?: RawAxiosRequestConfig): AxiosPromise<RegisterGenericCrmResponse>;
...
/**
 * Request parameters for integrationSettings operation in IntegrationSettingsApi.
 * @export
 * @interface IntegrationSettingsApiIntegrationSettingsRequest
 */
export interface IntegrationSettingsApiIntegrationSettingsRequest {
    /**
     * 
     * @type {IntegrationSettingsRequest}
     * @memberof IntegrationSettingsApiIntegrationSettings
     */
    readonly integrationSettingsRequest: IntegrationSettingsRequest
}

/**
 * IntegrationSettingsApi - object-oriented interface
 * @export
 * @class IntegrationSettingsApi
 * @extends {BaseAPI}
 */
export class IntegrationSettingsApi extends BaseAPI implements IntegrationSettingsApiInterface {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:integration-settings:write\'.
     * @summary Integration Settings (/v2/integration-settings)
     * @param {IntegrationSettingsApiIntegrationSettingsRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof IntegrationSettingsApi
     */
    public integrationSettings(requestParameters: IntegrationSettingsApiIntegrationSettingsRequest, options?: RawAxiosRequestConfig) {
        return IntegrationSettingsApiFp(this.configuration).integrationSettings(requestParameters.integrationSettingsRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
