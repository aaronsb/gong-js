...
// @ts-ignore
import type { Scorecards } from '../models';
// @ts-ignore
import type { Trackers } from '../models';
// @ts-ignore
import type { WorkspacesMetadata } from '../models';
/**
...
export const SettingsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        listScorecards: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/settings/scorecards`;
         ...
         * @param {string} [workspaceId] The ID of the workspace the keyword trackers are in. When empty, all trackers in all workspaces are returned.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listTrackers: async (workspaceId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/settings/trackers`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        listWorkspaces: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v2/workspaces`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const SettingsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listScorecards(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Scorecards>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listScorecards(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SettingsApi.listScorecards']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async listTrackers(workspaceId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Trackers>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listTrackers(workspaceId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SettingsApi.listTrackers']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Returns a list of all workspaces including their details.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:workspaces:read\'.
         ...
         * @throws {RequiredError}
         */
        async listWorkspaces(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WorkspacesMetadata>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listWorkspaces(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SettingsApi.listWorkspaces']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const SettingsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listScorecards(options?: RawAxiosRequestConfig): AxiosPromise<Scorecards> {
            return localVarFp.listScorecards(options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves details of all keyword trackers in the system or in a given workspace.  When accessed through a Bearer token authorization method, this endpoint requires the  \'api:settings:trackers:read\' scope.
         * @summary Retrieve tracker details (/v2/settings/trackers)
         * @param {SettingsApiListTrackersRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listTrackers(requestParameters: SettingsApiListTrackersRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Trackers> {
            return localVarFp.listTrackers(requestParameters.workspaceId, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a list of all workspaces including their details.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:workspaces:read\'.
         * @summary List all company workspaces (/v2/workspaces)
         ...
         * @throws {RequiredError}
         */
        listWorkspaces(options?: RawAxiosRequestConfig): AxiosPromise<WorkspacesMetadata> {
...
/**
 * Request parameters for listTrackers operation in SettingsApi.
 * @export
 * @interface SettingsApiListTrackersRequest
 */
export interface SettingsApiListTrackersRequest {
    /**
     * The ID of the workspace the keyword trackers are in. When empty, all trackers in all workspaces are returned.
     * @type {string}
     * @memberof SettingsApiListTrackers
     */
...
export class SettingsApi extends BaseAPI implements SettingsApiInterface {
     ...
     */
    public listScorecards(options?: RawAxiosRequestConfig) {
        return SettingsApiFp(this.configuration).listScorecards(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SettingsApi
     */
    public listTrackers(requestParameters: SettingsApiListTrackersRequest = {}, options?: RawAxiosRequestConfig) {
        return SettingsApiFp(this.configuration).listTrackers(requestParameters.workspaceId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public listWorkspaces(options?: RawAxiosRequestConfig) {
        return SettingsApiFp(this.configuration).listWorkspaces(options).then((request) => request(this.axios, this.basePath));
    }
}
