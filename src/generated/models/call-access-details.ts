...
// @ts-ignore
import type { UserAccessDetails } from './user-access-details';

/**
 * Call access details
 * @export
 * @interface CallAccessDetails
 */
export interface CallAccessDetails {
    /**
     * Gong\'s unique numeric call ID.
     * @type {string}
     * @memberof CallAccessDetails
     */
    'callId'?: string;
    /**
     * A list of users having access.
     * @type {Array<UserAccessDetails>}
     * @memberof CallAccessDetails
     */
    'users'?: Array<UserAccessDetails>;
}
