...
// @ts-ignore
import type { CallAccessDetails } from './call-access-details';

/**
 * 
 * @export
 * @interface CallsAccessDetailsResponse
 */
export interface CallsAccessDetailsResponse {
    /**
     * A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
     * @type {string}
     * @memberof CallsAccessDetailsResponse
     */
    'requestId'?: string;
    /**
     * A list, in which each item specifies a call & users with access to this call.
     * @type {Array<CallAccessDetails>}
     * @memberof CallsAccessDetailsResponse
     */
    'callAccessList'?: Array<CallAccessDetails>;
}
