...
export const UserSettingsHistorySettingEnum = {
    ...
    GONG_CONNECT_ENABLED: 'gongConnectEnabled',
    CALLS_IMPORTED: 'callsImported',
    INTERVIEWS_RECORDED: 'interviewsRecorded',
    PREVENT_INTERVIEW_RECORDING: 'preventInterviewRecording'
} as const;
