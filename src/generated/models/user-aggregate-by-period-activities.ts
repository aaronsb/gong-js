...
// @ts-ignore
import type { AggregateActivityWithDates } from './aggregate-activity-with-dates';

/**
 * A list, in which each item contains details of one user\'s activities.
 * @export
 * @interface UserAggregateByPeriodActivities
 */
export interface UserAggregateByPeriodActivities {
    /**
     * Gong\'s unique numeric identifier for the user (up to 20 digits).
     * @type {string}
     * @memberof UserAggregateByPeriodActivities
     */
    'userId'?: string;
    /**
     ...
     * @type {Array<AggregateActivityWithDates>}
     * @memberof UserAggregateByPeriodActivities
     */
    'userAggregateActivity'?: Array<AggregateActivityWithDates>;
}
