 ...
 * @export
 * @interface GenericCrmIntegration
 */
export interface GenericCrmIntegration {
    /**
     * The ID of the integration.<br><b>Note:</b> Parse the integrationId as Long or BigInt. Parsing the integrationId as an Integer truncates the integrationId to trailing zeros and returns an incorrect ID.
     * @type {number}
     * @memberof GenericCrmIntegration
     */
