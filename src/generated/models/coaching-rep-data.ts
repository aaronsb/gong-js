 ...
 * 
 * @export
 * @interface CoachingRepData
 */
export interface CoachingRepData {
    /**
     * 
     * @type {CoachingUser}
     * @memberof CoachingRepData
     */
    'report'?: CoachingUser;
    /**
     * 
     * @type {{ [key: string]: Set<string> | undefined; }}
     * @memberof CoachingRepData
     */
    'metrics'?: { [key: string]: Set<string> | undefined; };
}
