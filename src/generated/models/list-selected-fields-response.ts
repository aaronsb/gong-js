...
// @ts-ignore
import type { GenericSchemaFieldRequest } from './generic-schema-field-request';

/**
 * 
 * @export
 * @interface ListSelectedFieldsResponse
 */
export interface ListSelectedFieldsResponse {
    /**
     * A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
     * @type {string}
     * @memberof ListSelectedFieldsResponse
     */
    'requestId'?: string;
    /**
     * selectedFields
     * @type {{ [key: string]: Array<GenericSchemaFieldRequest> | undefined; }}
     * @memberof ListSelectedFieldsResponse
     */
    'objectTypeToSelectedFields'?: { [key: string]: Array<GenericSchemaFieldRequest> | undefined; };
}
