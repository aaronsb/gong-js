...
// @ts-ignore
import type { CallsFilter } from './calls-filter';

/**
 * 
 * @export
 * @interface PublicApiBaseRequestV2CallsFilter
 */
export interface PublicApiBaseRequestV2CallsFilter {
    /**
     * When paging is needed, provide the value supplied by the previous API call to bring the following page of records.
     * @type {string}
     * @memberof PublicApiBaseRequestV2CallsFilter
     */
    'cursor'?: string;
    /**
     * 
