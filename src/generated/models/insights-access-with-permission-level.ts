...
export const InsightsAccessWithPermissionLevelPermissionLevelEnum = {
    ALL: 'all',
    MANAGERS_TEAM: 'managers-team',
    REPORT_TO_THEM: 'report-to-them',
    OWN: 'own',
    NONE: 'none',
    ALL___MANAGERS_TEAM___REPORT_TO_THEM___OWN___NONE: 'all / managers-team / report-to-them / own / none'
} as const;
