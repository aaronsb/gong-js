...
// @ts-ignore
import type { InteractionStatsDto } from './interaction-stats-dto';
// May contain unused imports in some cases
// @ts-ignore
import type { Questions } from './questions';
// May contain unused imports in some cases
// @ts-ignore
import type { UserSpeaker } from './user-speaker';
// May contain unused imports in some cases
// @ts-ignore
import type { VideoInteractionDto } from './video-interaction-dto';

/**
 * Metrics collected around the interaction during the call.
 * @export
 * @interface InteractionMeasuresDto
 */
export interface InteractionMeasuresDto {
    /**
     * A list of the talk duration per speaker.
     * @type {Array<UserSpeaker>}
     * @memberof InteractionMeasuresDto
     */
    'speakers'?: Array<UserSpeaker>;
    /**
     ...
     * @type {Array<InteractionStatsDto>}
     * @memberof InteractionMeasuresDto
     */
    'interactionStats'?: Array<InteractionStatsDto>;
    /**
     * A list of video statistics about what\'s presented and for how long.
     * @type {Array<VideoInteractionDto>}
     * @memberof InteractionMeasuresDto
     */
    'video'?: Array<VideoInteractionDto>;
    /**
     * 
     * @type {Questions}
     * @memberof InteractionMeasuresDto
