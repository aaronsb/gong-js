...
// @ts-ignore
import type { PermissionProfileDTO } from './permission-profile-dto';
...
export interface PermissionProfilesResponse {
     ...
     * @type {string}
     * @memberof PermissionProfilesResponse
     */
    'requestId'?: string;
    /**
     * A list, in which each item specifies a permission profile.
     * @type {Array<PermissionProfileDTO>}
     * @memberof PermissionProfilesResponse
     */
    'profiles'?: Array<PermissionProfileDTO>;
}
