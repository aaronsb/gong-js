...
// @ts-ignore
import type { CallOutlineItem } from './call-outline-item';

/**
 * 
 * @export
 * @interface CallOutlineSection
 */
export interface CallOutlineSection {
    /**
     * The name of this section of the call.
     * @type {string}
     * @memberof CallOutlineSection
     */
    'section'?: string;
    /**
     ...
     * @type {Array<CallOutlineItem>}
     * @memberof CallOutlineSection
     */
    'items'?: Array<CallOutlineItem>;
}
