...
// @ts-ignore
import type { MeetingInvitee } from './meeting-invitee';

/**
 * 
 * @export
 * @interface NewMeetingResponse
 */
export interface NewMeetingResponse {
    /**
     * A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
     * @type {string}
     * @memberof NewMeetingResponse
     */
    'requestId'?: string;
    /**
     ...
     * @type {Array<MeetingInvitee>}
     * @memberof NewMeetingResponse
     */
    'additionalInvitees'?: Array<MeetingInvitee>;
}
