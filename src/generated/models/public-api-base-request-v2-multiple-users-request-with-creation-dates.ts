...
// @ts-ignore
import type { MultipleUsersRequestWithCreationDates } from './multiple-users-request-with-creation-dates';

/**
 * 
 * @export
 * @interface PublicApiBaseRequestV2MultipleUsersRequestWithCreationDates
 */
export interface PublicApiBaseRequestV2MultipleUsersRequestWithCreationDates {
    /**
     * When paging is needed, provide the value supplied by the previous API call to bring the following page of records.
     * @type {string}
     * @memberof PublicApiBaseRequestV2MultipleUsersRequestWithCreationDates
     */
    'cursor'?: string;
    /**
     * 
     * @type {MultipleUsersRequestWithCreationDates}
     * @memberof PublicApiBaseRequestV2MultipleUsersRequestWithCreationDates
     */
    'filter': MultipleUsersRequestWithCreationDates;
}
