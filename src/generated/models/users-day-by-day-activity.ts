...
// May contain unused imports in some cases
// @ts-ignore
import type { UserDayByDayActivity } from './user-day-by-day-activity';

/**
 * 
 * @export
 * @interface UsersDayByDayActivity
 */
export interface UsersDayByDayActivity {
    /**
     * A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
     * @type {string}
     * @memberof UsersDayByDayActivity
     */
    'requestId'?: string;
    /**
     * 
     ...
     * @type {Array<UserDayByDayActivity>}
     * @memberof UsersDayByDayActivity
     */
    'usersDetailedActivities'?: Array<UserDayByDayActivity>;
}
