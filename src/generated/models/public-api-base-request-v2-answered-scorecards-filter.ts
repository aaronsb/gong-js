...
// @ts-ignore
import type { AnsweredScorecardsFilter } from './answered-scorecards-filter';

/**
 * 
 * @export
 * @interface PublicApiBaseRequestV2AnsweredScorecardsFilter
 */
export interface PublicApiBaseRequestV2AnsweredScorecardsFilter {
    /**
     * When paging is needed, provide the value supplied by the previous API call to bring the following page of records.
     * @type {string}
     * @memberof PublicApiBaseRequestV2AnsweredScorecardsFilter
     */
    'cursor'?: string;
    /**
     * 
     * @type {AnsweredScorecardsFilter}
     * @memberof PublicApiBaseRequestV2AnsweredScorecardsFilter
     */
    'filter': AnsweredScorecardsFilter;
}
