 ...
 * @export
 */
export const DigitalInteractionsApiAxiosParamCreator = function (configuration) {
    return {
        /**
         ...
         */
        addDigitalInteraction: async (digitalInteractionRequest, options = {}) => {
 ...
 * @export
 */
export const DigitalInteractionsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addDigitalInteraction(digitalInteractionRequest, options) {
 ...
 * @export
 */
export const DigitalInteractionsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addDigitalInteraction(requestParameters, options) {
 ...
 * @extends {BaseAPI}
 */
export class DigitalInteractionsApi extends BaseAPI {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:digital-interactions:write\'.
     * @summary Post a Digital Interaction (/v2/digital-interaction)
     * @param {DigitalInteractionsApiAddDigitalInteractionRequest} requestParameters Request parameters.
