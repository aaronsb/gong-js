 ...
 * @export
 */
export const IntegrationSettingsApiAxiosParamCreator = function (configuration) {
    return {
        /**
         ...
         */
        integrationSettings: async (integrationSettingsRequest, options = {}) => {
 ...
 * @export
 */
export const IntegrationSettingsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async integrationSettings(integrationSettingsRequest, options) {
 ...
 * @export
 */
export const IntegrationSettingsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        integrationSettings(requestParameters, options) {
 ...
 * @extends {BaseAPI}
 */
export class IntegrationSettingsApi extends BaseAPI {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:integration-settings:write\'.
     * @summary Integration Settings (/v2/integration-settings)
     * @param {IntegrationSettingsApiIntegrationSettingsRequest} requestParameters Request parameters.
