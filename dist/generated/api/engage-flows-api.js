 ...
 * @export
 */
export const EngageFlowsApiAxiosParamCreator = function (configuration) {
    return {
        /**
         ...
         */
        assignProspects: async (assignFlowRequestV2, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        getFlowsForProspects: async (prospectsAssignedFlowsRequestV2, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        listFlows: async (flowOwnerEmail, cursor, workspaceId, options = {}) => {
 ...
 * @export
 */
export const EngageFlowsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async assignProspects(assignFlowRequestV2, options) {
         ...
         * @throws {RequiredError}
         */
        async getFlowsForProspects(prospectsAssignedFlowsRequestV2, options) {
         ...
         * @throws {RequiredError}
         */
        async listFlows(flowOwnerEmail, cursor, workspaceId, options) {
 ...
 * @export
 */
export const EngageFlowsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        assignProspects(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        getFlowsForProspects(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        listFlows(requestParameters, options) {
 ...
 * @extends {BaseAPI}
 */
export class EngageFlowsApi extends BaseAPI {
    /**
     * Use this endpoint to assign a number of prospects to a flow. Prospects can be contacts or leads in your CRM.  Generate a list of comma separated CRM Ids of the prospects you want to add to a flow. The flowInstanceOwnerEmail parameter is the email address of the Gong user who set up the flow instance and owns the flow to-dos.  You can assign up to 200 prospects to a flow in a single request.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:flows:write\'.
     * @summary Assign prospects (contacts or leads) to an Engage flow  (/v2/flows/prospects/assign)
     * @param {EngageFlowsApiAssignProspectsRequest} requestParameters Request parameters.
