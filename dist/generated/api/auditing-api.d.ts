 ...
 * @export
 */
export declare const AuditingApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     */
    listLogs: (logType: ListLogsLogTypeEnum, fromDateTime: string, toDateTime?: string, cursor?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * AuditingApi - functional programming interface
 * @export
 */
export declare const AuditingApiFp: (configuration?: Configuration) => {
    /**
     * List log entries that took place during a specified time range.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:logs:read\'.
     * @summary Retrieve logs data by type and time range (/v2/logs)
     * @param {ListLogsLogTypeEnum} logType Type of logs requested.
     ...
     * @throws {RequiredError}
     */
    listLogs(logType: ListLogsLogTypeEnum, fromDateTime: string, toDateTime?: string, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LogsResponse>>;
};
/**
 * AuditingApi - factory interface
 * @export
 */
export declare const AuditingApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * List log entries that took place during a specified time range.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:logs:read\'.
     * @summary Retrieve logs data by type and time range (/v2/logs)
 ...
 * @extends {BaseAPI}
 */
export declare class AuditingApi extends BaseAPI implements AuditingApiInterface {
    /**
     * List log entries that took place during a specified time range.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:logs:read\'.
     * @summary Retrieve logs data by type and time range (/v2/logs)
     * @param {AuditingApiListLogsRequest} requestParameters Request parameters.
     ...
     */
    listLogs(requestParameters: AuditingApiListLogsRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<LogsResponse, any>>;
}
/**
 * @export
 */
export declare const ListLogsLogTypeEnum: {
    readonly ACCESS_LOG: "AccessLog";
    readonly USER_ACTIVITY_LOG: "UserActivityLog";
    readonly USER_CALL_PLAY: "UserCallPlay";
    readonly EXTERNALLY_SHARED_CALL_ACCESS: "ExternallySharedCallAccess";
    readonly EXTERNALLY_SHARED_CALL_PLAY: "ExternallySharedCallPlay";
};
