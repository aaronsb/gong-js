 ...
 * @export
 */
export const EngagementLegacySeeDigitalInteractionsApiAxiosParamCreator = function (configuration) {
    return {
        /**
         ...
         */
        contentShared: async (contentSharedEvent, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        contentViewed: async (contentViewedEvent, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        customAction: async (customActionEvent, options = {}) => {
 ...
 * @export
 */
export const EngagementLegacySeeDigitalInteractionsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async contentShared(contentSharedEvent, options) {
         ...
         * @throws {RequiredError}
         */
        async contentViewed(contentViewedEvent, options) {
         ...
         * @throws {RequiredError}
         */
        async customAction(customActionEvent, options) {
 ...
 * @export
 */
export const EngagementLegacySeeDigitalInteractionsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        contentShared(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        contentViewed(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        customAction(requestParameters, options) {
 ...
 * @extends {BaseAPI}
 */
export class EngagementLegacySeeDigitalInteractionsApi extends BaseAPI {
    /**
     * Push engagement events into Gong and display them as events in Gong’s activity timeline, when a Gong user shares content with external participants (for example, a contract was “shared” by the account executive with his prospects)  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:engagement-data:write\'.
     * @summary Report event of a content share (/v2/customer-engagement/content/shared)
     * @param {EngagementLegacySeeDigitalInteractionsApiContentSharedRequest} requestParameters Request parameters.
