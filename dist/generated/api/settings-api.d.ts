...
export declare const SettingsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    listScorecards: (options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listTrackers: (workspaceId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const SettingsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listScorecards(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Scorecards>>;
    /**
     * Retrieves details of all keyword trackers in the system or in a given workspace.  When accessed through a Bearer token authorization method, this endpoint requires the  \'api:settings:trackers:read\' scope.
     * @summary Retrieve tracker details (/v2/settings/trackers)
     * @param {string} [workspaceId] The ID of the workspace the keyword trackers are in. When empty, all trackers in all workspaces are returned.
     ...
     * @throws {RequiredError}
     */
    listTrackers(workspaceId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Trackers>>;
    /**
     * Returns a list of all workspaces including their details.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:workspaces:read\'.
     * @summary List all company workspaces (/v2/workspaces)
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    listWorkspaces(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WorkspacesMetadata>>;
};
/**
 ...
 * @extends {BaseAPI}
 */
export declare class SettingsApi extends BaseAPI implements SettingsApiInterface {
    /**
     * Retrieve all the scorecards within the Gong system.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:settings:scorecards:read\'.
     * @summary Retrieve scorecards details (/v2/settings/scorecards)
     * @param {*} [options] Override http request option.
     ...
     */
    listScorecards(options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<Scorecards, any>>;
    /**
     * Retrieves details of all keyword trackers in the system or in a given workspace.  When accessed through a Bearer token authorization method, this endpoint requires the  \'api:settings:trackers:read\' scope.
     * @summary Retrieve tracker details (/v2/settings/trackers)
     * @param {SettingsApiListTrackersRequest} requestParameters Request parameters.
     ...
     * @memberof SettingsApi
     */
    listTrackers(requestParameters?: SettingsApiListTrackersRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<Trackers, any>>;
    /**
     * Returns a list of all workspaces including their details.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:workspaces:read\'.
     * @summary List all company workspaces (/v2/workspaces)
     * @param {*} [options] Override http request option.
     ...
     * @memberof SettingsApi
     */
    listWorkspaces(options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<WorkspacesMetadata, any>>;
}
