...
export declare const LibraryApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getCallsInSpecificFolder: (folderId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getLibraryStructure: (workspaceId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const LibraryApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getCallsInSpecificFolder(folderId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LibraryFolderListOfCallsResponse>>;
    /**
     * Use this endpoint to retrieve a list of public library folders. We do not allow retrieval of either private or archived folders.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:library:read\'.
     * @summary Retrieve Library folders (/v2/library/folders)
     * @param {string} [workspaceId] Workspace identifier. We will retrieve folders which are related to this specific workspace.
     ...
     * @throws {RequiredError}
     */
    getLibraryStructure(workspaceId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LibraryResponse>>;
};
/**
 ...
 * @extends {BaseAPI}
 */
export declare class LibraryApi extends BaseAPI implements LibraryApiInterface {
    /**
     * Given a folder id, this endpoint retrieves a list of calls in it.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:library:read\'.
     * @summary List of calls in a specific folder (/v2/library/folder-content)
     * @param {LibraryApiGetCallsInSpecificFolderRequest} requestParameters Request parameters.
     ...
     * @memberof LibraryApi
     */
    getCallsInSpecificFolder(requestParameters?: LibraryApiGetCallsInSpecificFolderRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<LibraryFolderListOfCallsResponse, any>>;
    /**
     * Use this endpoint to retrieve a list of public library folders. We do not allow retrieval of either private or archived folders.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:library:read\'.
     * @summary Retrieve Library folders (/v2/library/folders)
     * @param {LibraryApiGetLibraryStructureRequest} requestParameters Request parameters.
     ...
     * @memberof LibraryApi
     */
    getLibraryStructure(requestParameters?: LibraryApiGetLibraryStructureRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<LibraryResponse, any>>;
}
