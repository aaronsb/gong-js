 ...
 * @export
 */
export declare const IntegrationSettingsApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     */
    integrationSettings: (integrationSettingsRequest: IntegrationSettingsRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * IntegrationSettingsApi - functional programming interface
 * @export
 */
export declare const IntegrationSettingsApiFp: (configuration?: Configuration) => {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:integration-settings:write\'.
     * @summary Integration Settings (/v2/integration-settings)
     * @param {IntegrationSettingsRequest} integrationSettingsRequest
     ...
     * @throws {RequiredError}
     */
    integrationSettings(integrationSettingsRequest: IntegrationSettingsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegisterGenericCrmResponse>>;
};
/**
 * IntegrationSettingsApi - factory interface
 * @export
 */
export declare const IntegrationSettingsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:integration-settings:write\'.
     * @summary Integration Settings (/v2/integration-settings)
 ...
 * @extends {BaseAPI}
 */
export declare class IntegrationSettingsApi extends BaseAPI implements IntegrationSettingsApiInterface {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:integration-settings:write\'.
     * @summary Integration Settings (/v2/integration-settings)
     * @param {IntegrationSettingsApiIntegrationSettingsRequest} requestParameters Request parameters.
     ...
     */
    integrationSettings(requestParameters: IntegrationSettingsApiIntegrationSettingsRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<RegisterGenericCrmResponse, any>>;
}
