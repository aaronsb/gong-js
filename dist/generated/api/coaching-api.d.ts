...
import type { CoachingMetrics } from '../models';
/**
 * CoachingApi - axios parameter creator
 * @export
 */
export declare const CoachingApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     */
    listUsers1: (workspaceId: number, managerId: number, from: string, to: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * CoachingApi - functional programming interface
 * @export
 */
export declare const CoachingApiFp: (configuration?: Configuration) => {
    /**
     * List all of the coaching metrics of a manager.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:coaching:read\'.
     * @summary List all coaching metrics (/v2/coaching)
     * @param {number} workspaceId
     ...
     * @throws {RequiredError}
     */
    listUsers1(workspaceId: number, managerId: number, from: string, to: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoachingMetrics>>;
};
/**
 * CoachingApi - factory interface
 * @export
 */
export declare const CoachingApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * List all of the coaching metrics of a manager.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:coaching:read\'.
     * @summary List all coaching metrics (/v2/coaching)
...
/**
 * CoachingApi - interface
 * @export
 * @interface CoachingApi
 */
export interface CoachingApiInterface {
    /**
     * List all of the coaching metrics of a manager.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:coaching:read\'.
     * @summary List all coaching metrics (/v2/coaching)
     * @param {CoachingApiListUsers1Request} requestParameters Request parameters.
 ...
 * @extends {BaseAPI}
 */
export declare class CoachingApi extends BaseAPI implements CoachingApiInterface {
    /**
     * List all of the coaching metrics of a manager.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:coaching:read\'.
     * @summary List all coaching metrics (/v2/coaching)
     * @param {CoachingApiListUsers1Request} requestParameters Request parameters.
     ...
     */
    listUsers1(requestParameters: CoachingApiListUsers1Request, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<CoachingMetrics, any>>;
}
