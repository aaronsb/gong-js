 ...
 * @export
 */
export const AuditingApiAxiosParamCreator = function (configuration) {
    return {
        /**
         ...
         */
        listLogs: async (logType, fromDateTime, toDateTime, cursor, options = {}) => {
 ...
 * @export
 */
export const AuditingApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listLogs(logType, fromDateTime, toDateTime, cursor, options) {
 ...
 * @export
 */
export const AuditingApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listLogs(requestParameters, options) {
 ...
 * @extends {BaseAPI}
 */
export class AuditingApi extends BaseAPI {
    /**
     * List log entries that took place during a specified time range.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:logs:read\'.
     * @summary Retrieve logs data by type and time range (/v2/logs)
     * @param {AuditingApiListLogsRequest} requestParameters Request parameters.
