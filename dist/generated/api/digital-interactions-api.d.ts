 ...
 * @export
 */
export declare const DigitalInteractionsApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     */
    addDigitalInteraction: (digitalInteractionRequest: DigitalInteractionRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * DigitalInteractionsApi - functional programming interface
 * @export
 */
export declare const DigitalInteractionsApiFp: (configuration?: Configuration) => {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:digital-interactions:write\'.
     * @summary Post a Digital Interaction (/v2/digital-interaction)
     * @param {DigitalInteractionRequest} digitalInteractionRequest
     ...
     * @throws {RequiredError}
     */
    addDigitalInteraction(digitalInteractionRequest: DigitalInteractionRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EventAcceptedResponse>>;
};
/**
 * DigitalInteractionsApi - factory interface
 * @export
 */
export declare const DigitalInteractionsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:digital-interactions:write\'.
     * @summary Post a Digital Interaction (/v2/digital-interaction)
 ...
 * @extends {BaseAPI}
 */
export declare class DigitalInteractionsApi extends BaseAPI implements DigitalInteractionsApiInterface {
    /**
     * When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:digital-interactions:write\'.
     * @summary Post a Digital Interaction (/v2/digital-interaction)
     * @param {DigitalInteractionsApiAddDigitalInteractionRequest} requestParameters Request parameters.
     ...
     */
    addDigitalInteraction(requestParameters: DigitalInteractionsApiAddDigitalInteractionRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<EventAcceptedResponse, any>>;
}
