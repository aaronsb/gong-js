 ...
 * @export
 */
export declare const EngageFlowsApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     */
    assignProspects: (assignFlowRequestV2: AssignFlowRequestV2, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getFlowsForProspects: (prospectsAssignedFlowsRequestV2: ProspectsAssignedFlowsRequestV2, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listFlows: (flowOwnerEmail: string, cursor?: string, workspaceId?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * EngageFlowsApi - functional programming interface
 * @export
 */
export declare const EngageFlowsApiFp: (configuration?: Configuration) => {
    /**
     * Use this endpoint to assign a number of prospects to a flow. Prospects can be contacts or leads in your CRM.  Generate a list of comma separated CRM Ids of the prospects you want to add to a flow. The flowInstanceOwnerEmail parameter is the email address of the Gong user who set up the flow instance and owns the flow to-dos.  You can assign up to 200 prospects to a flow in a single request.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:flows:write\'.
     * @summary Assign prospects (contacts or leads) to an Engage flow  (/v2/flows/prospects/assign)
     * @param {AssignFlowRequestV2} assignFlowRequestV2
     ...
     * @throws {RequiredError}
     */
    assignProspects(assignFlowRequestV2: AssignFlowRequestV2, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AssignFlowResponse>>;
    /**
     * Get the Gong Engage flows assigned to the given prospects.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:flows:read\'.
     * @summary List assigned flows for the given prospects (/v2/flows/prospects)
     * @param {ProspectsAssignedFlowsRequestV2} prospectsAssignedFlowsRequestV2
     ...
     * @throws {RequiredError}
     */
    getFlowsForProspects(prospectsAssignedFlowsRequestV2: ProspectsAssignedFlowsRequestV2, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProspectsFlowsResponse>>;
    /**
     * Engage flows have the following visibility types:   * Company: visible to everyone in the company, can only be edited by users with edit permissions.   * Personal: reps can set up their own flows which are only available to them.   * Shared: reps can share a flow with other reps. Those reps can then add leads to the flow.   This endpoint returns all company flows, together with personal flows and flows shared with the user specified in the flowEmailOwner parameter.   When accessed through a Bearer token authorization method, use the \'api:flows:read\' scope.
     * @summary List Gong Engage flows (/v2/flows)
     * @param {string} flowOwnerEmail Email of the Gong user whose personal flows and flows shared with the user you want to return.
     ...
     * @throws {RequiredError}
     */
    listFlows(flowOwnerEmail: string, cursor?: string, workspaceId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FlowsResponse>>;
};
/**
 * EngageFlowsApi - factory interface
 * @export
 */
export declare const EngageFlowsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Use this endpoint to assign a number of prospects to a flow. Prospects can be contacts or leads in your CRM.  Generate a list of comma separated CRM Ids of the prospects you want to add to a flow. The flowInstanceOwnerEmail parameter is the email address of the Gong user who set up the flow instance and owns the flow to-dos.  You can assign up to 200 prospects to a flow in a single request.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:flows:write\'.
     * @summary Assign prospects (contacts or leads) to an Engage flow  (/v2/flows/prospects/assign)
 ...
 * @extends {BaseAPI}
 */
export declare class EngageFlowsApi extends BaseAPI implements EngageFlowsApiInterface {
    /**
     * Use this endpoint to assign a number of prospects to a flow. Prospects can be contacts or leads in your CRM.  Generate a list of comma separated CRM Ids of the prospects you want to add to a flow. The flowInstanceOwnerEmail parameter is the email address of the Gong user who set up the flow instance and owns the flow to-dos.  You can assign up to 200 prospects to a flow in a single request.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:flows:write\'.
     * @summary Assign prospects (contacts or leads) to an Engage flow  (/v2/flows/prospects/assign)
     * @param {EngageFlowsApiAssignProspectsRequest} requestParameters Request parameters.
     ...
     */
    assignProspects(requestParameters: EngageFlowsApiAssignProspectsRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<AssignFlowResponse, any>>;
    /**
     * Get the Gong Engage flows assigned to the given prospects.  When accessed through a Bearer token authorization method, this endpoint requires the scope \'api:flows:read\'.
     * @summary List assigned flows for the given prospects (/v2/flows/prospects)
     * @param {EngageFlowsApiGetFlowsForProspectsRequest} requestParameters Request parameters.
     ...
     * @memberof EngageFlowsApi
     */
    getFlowsForProspects(requestParameters: EngageFlowsApiGetFlowsForProspectsRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<ProspectsFlowsResponse, any>>;
    /**
     * Engage flows have the following visibility types:   * Company: visible to everyone in the company, can only be edited by users with edit permissions.   * Personal: reps can set up their own flows which are only available to them.   * Shared: reps can share a flow with other reps. Those reps can then add leads to the flow.   This endpoint returns all company flows, together with personal flows and flows shared with the user specified in the flowEmailOwner parameter.   When accessed through a Bearer token authorization method, use the \'api:flows:read\' scope.
     * @summary List Gong Engage flows (/v2/flows)
     * @param {EngageFlowsApiListFlowsRequest} requestParameters Request parameters.
     ...
     * @memberof EngageFlowsApi
     */
    listFlows(requestParameters: EngageFlowsApiListFlowsRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FlowsResponse, any>>;
}
