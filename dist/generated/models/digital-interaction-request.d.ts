 ...
 * @export
 * @interface DigitalInteractionRequest
 */
export interface DigitalInteractionRequest {
    /**
     * The provider\'s unique identifier for the event used for deduplication
     * @type {string}
     * @memberof DigitalInteractionRequest
     */
    'eventId': string;
    /**
     ...
     * @memberof DigitalInteractionRequest
     */
    'device'?: DigitalInteractionRequestDeviceEnum;
    /**
     *
     * @type {Content}
     * @memberof DigitalInteractionRequest
...
export declare const DigitalInteractionRequestDeviceEnum: {
    readonly MOBILE: "MOBILE";
    readonly PC: "PC";
};
export type DigitalInteractionRequestDeviceEnum = typeof DigitalInteractionRequestDeviceEnum[keyof typeof DigitalInteractionRequestDeviceEnum];
