 ...
 */
import type { ExternalCrmPartyObject } from './external-crm-party-object';
/**
 ...
 * @export
 * @interface PartyUploadContext
 */
export interface PartyUploadContext {
    /**
     * External system name. Currently only Salesforce and Generic are supported.
     * @type {string}
     * @memberof PartyUploadContext
     */
    'system': PartyUploadContextSystemEnum;
    /**
     * List of objects within the external system
     * @type {Array<ExternalCrmPartyObject>}
     * @memberof PartyUploadContext
     */
    'objects'?: Array<ExternalCrmPartyObject>;
}
export declare const PartyUploadContextSystemEnum: {
    readonly SALESFORCE: "Salesforce";
    readonly HUB_SPOT: "HubSpot";
    readonly MICROSOFT_DYNAMIC: "MicrosoftDynamic";
    readonly GENERIC: "Generic";
};
export type PartyUploadContextSystemEnum = typeof PartyUploadContextSystemEnum[keyof typeof PartyUploadContextSystemEnum];
