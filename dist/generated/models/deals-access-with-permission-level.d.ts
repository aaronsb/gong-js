 ...
 * @export
 * @interface DealsAccessWithPermissionLevel
 */
export interface DealsAccessWithPermissionLevel {
    /**
     * Permission access scope.
     * @type {string}
     * @memberof DealsAccessWithPermissionLevel
     */
    'permissionLevel'?: DealsAccessWithPermissionLevelPermissionLevelEnum;
    /**
...
export declare const DealsAccessWithPermissionLevelPermissionLevelEnum: {
    readonly ALL: "all";
...
export type DealsAccessWithPermissionLevelPermissionLevelEnum = typeof DealsAccessWithPermissionLevelPermissionLevelEnum[keyof typeof DealsAccessWithPermissionLevelPermissionLevelEnum];
