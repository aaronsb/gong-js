 ...
 */
import type { ManualAssociationsBasicData } from './manual-associations-basic-data';
import type { Records } from './records';
/**
 *
 * @export
 * @interface ManualAssociationResponse
 */
export interface ManualAssociationResponse {
    /**
     * A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
     * @type {string}
     * @memberof ManualAssociationResponse
     */
    'requestId'?: string;
    /**
     *
     ...
     * @type {Array<ManualAssociationsBasicData>}
     * @memberof ManualAssociationResponse
     */
    'associations'?: Array<ManualAssociationsBasicData>;
}
