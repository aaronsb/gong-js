 ...
 * @export
 * @interface PersonBusinessContext
 */
export interface PersonBusinessContext {
    /**
     * The object type in the external system
     * @type {string}
     * @memberof PersonBusinessContext
     */
    'objectType': PersonBusinessContextObjectTypeEnum;
    /**
...
export declare const PersonBusinessContextObjectTypeEnum: {
    readonly CONTACT: "CONTACT";
    readonly LEAD: "LEAD";
};
export type PersonBusinessContextObjectTypeEnum = typeof PersonBusinessContextObjectTypeEnum[keyof typeof PersonBusinessContextObjectTypeEnum];
