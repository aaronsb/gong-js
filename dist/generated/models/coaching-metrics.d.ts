 ...
 */
import type { CoachingMetricsData } from './coaching-metrics-data';
/**
 *
 * @export
...
export interface CoachingMetrics {
     ...
     * @type {string}
     * @memberof CoachingMetrics
     */
    'requestId'?: string;
    /**
     * A list, in which each item specifies one managers coaching data
     * @type {Array<CoachingMetricsData>}
     * @memberof CoachingMetrics
     */
    'coachingData'?: Array<CoachingMetricsData>;
}
