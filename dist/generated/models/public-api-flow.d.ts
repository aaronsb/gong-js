 ...
 * @export
 * @interface PublicApiFlow
 */
export interface PublicApiFlow {
    /**
     * The id of the flow
     * @type {string}
     * @memberof PublicApiFlow
     */
    'id'?: string;
    /**
     ...
     * @memberof PublicApiFlow
     */
    'visibility'?: PublicApiFlowVisibilityEnum;
    /**
...
export declare const PublicApiFlowVisibilityEnum: {
    readonly COMPANY: "Company";
    readonly PERSONAL: "Personal";
    readonly SHARED: "Shared";
};
export type PublicApiFlowVisibilityEnum = typeof PublicApiFlowVisibilityEnum[keyof typeof PublicApiFlowVisibilityEnum];
