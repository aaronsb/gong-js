 ...
 * @export
 * @interface ForecastAccess
 */
export interface ForecastAccess {
    /**
     * Permission access scope.
     * @type {string}
     * @memberof ForecastAccess
     */
    'permissionLevel'?: ForecastAccessPermissionLevelEnum;
    /**
...
export declare const ForecastAccessPermissionLevelEnum: {
    readonly ALL: "all";
...
export type ForecastAccessPermissionLevelEnum = typeof ForecastAccessPermissionLevelEnum[keyof typeof ForecastAccessPermissionLevelEnum];
