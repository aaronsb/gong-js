 ...
 *
 * @export
 * @interface PublicApiAssignedFlow
 */
export interface PublicApiAssignedFlow {
    /**
     * The Gong Engage Flow ID the prospect was assigned to.
     * @type {string}
     * @memberof PublicApiAssignedFlow
     */
    'flowId'?: string;
    /**
     ...
     * @memberof PublicApiAssignedFlow
     */
    'flowInstanceStatus'?: PublicApiAssignedFlowFlowInstanceStatusEnum;
    /**
...
export declare const PublicApiAssignedFlowFlowInstanceStatusEnum: {
    readonly RUNNING: "Running";
    readonly PENDING: "Pending";
    readonly PAUSED: "Paused";
};
export type PublicApiAssignedFlowFlowInstanceStatusEnum = typeof PublicApiAssignedFlowFlowInstanceStatusEnum[keyof typeof PublicApiAssignedFlowFlowInstanceStatusEnum];
