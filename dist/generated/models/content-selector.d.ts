 ...
 */
import type { ExposedFields } from './exposed-fields';
/**
...
export interface ContentSelector {
     ...
     * @type {string}
     * @memberof ContentSelector
     */
    'context'?: ContentSelectorContextEnum;
    /**
     ...
     * @memberof ContentSelector
     */
    'contextTiming'?: Array<ContentSelectorContextTimingEnum>;
    /**
     *
     * @type {ExposedFields}
     * @memberof ContentSelector
...
export declare const ContentSelectorContextEnum: {
    readonly NONE: "None";
    readonly BASIC: "Basic";
    readonly EXTENDED: "Extended";
};
export type ContentSelectorContextEnum = typeof ContentSelectorContextEnum[keyof typeof ContentSelectorContextEnum];
export declare const ContentSelectorContextTimingEnum: {
    readonly NOW: "Now";
    readonly TIME_OF_CALL: "TimeOfCall";
};
export type ContentSelectorContextTimingEnum = typeof ContentSelectorContextTimingEnum[keyof typeof ContentSelectorContextTimingEnum];
