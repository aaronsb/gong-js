 ...
 */
import type { MultipleUsersWithDates } from './multiple-users-with-dates';
/**
 *
 * @export
 * @interface RequestWithTimePeriod
 */
export interface RequestWithTimePeriod {
    /**
     * When paging is needed, provide the value supplied by the previous API call to bring the following page of records.
     * @type {string}
     * @memberof RequestWithTimePeriod
     */
    'cursor'?: string;
    /**
     *
     * @type {MultipleUsersWithDates}
     * @memberof RequestWithTimePeriod
     */
    'filter': MultipleUsersWithDates;
    /**
     * Calendar time period for aggregating data. Note: First day of the week is Monday.
     * @type {string}
     * @memberof RequestWithTimePeriod
     */
    'aggregationPeriod': RequestWithTimePeriodAggregationPeriodEnum;
}
export declare const RequestWithTimePeriodAggregationPeriodEnum: {
    readonly DAY: "DAY";
    readonly WEEK: "WEEK";
...
export type RequestWithTimePeriodAggregationPeriodEnum = typeof RequestWithTimePeriodAggregationPeriodEnum[keyof typeof RequestWithTimePeriodAggregationPeriodEnum];
