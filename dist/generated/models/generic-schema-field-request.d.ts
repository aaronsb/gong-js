 ...
 * selectedFields
 * @export
 * @interface GenericSchemaFieldRequest
 */
export interface GenericSchemaFieldRequest {
    /**
     * The unique name of the field in the CRM system
     * @type {string}
     * @memberof GenericSchemaFieldRequest
     */
    'uniqueName': string;
    /**
     ...
     * @memberof GenericSchemaFieldRequest
     */
    'type': GenericSchemaFieldRequestTypeEnum;
    /**
     * The date and time the schema was last modified. <br>Valid format: ISO-8601 format without milliseconds e.g., \"2020-12-17T13:45:01Z\"
     * @type {string}
     * @memberof GenericSchemaFieldRequest
     */
    'lastModified'?: string;
...
export declare const GenericSchemaFieldRequestTypeEnum: {
    readonly DATE: "DATE";
...
export type GenericSchemaFieldRequestTypeEnum = typeof GenericSchemaFieldRequestTypeEnum[keyof typeof GenericSchemaFieldRequestTypeEnum];
