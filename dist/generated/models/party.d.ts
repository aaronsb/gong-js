 ...
 */
import type { PartyContextDto } from './party-context-dto';
/**
 *
 * @export
 * @interface Party
...
export interface Party {
     ...
     * @type {Array<PartyContextDto>}
     * @memberof Party
     */
    'context'?: Array<PartyContextDto>;
    /**
     * Whether the participant is from the company or not.
     * @type {string}
     * @memberof Party
     */
    'affiliation'?: PartyAffiliationEnum;
    /**
     ...
     * @memberof Party
     */
    'methods'?: Array<PartyMethodsEnum>;
}
export declare const PartyAffiliationEnum: {
    readonly INTERNAL: "Internal";
    readonly EXTERNAL: "External";
    readonly UNKNOWN: "Unknown";
};
export type PartyAffiliationEnum = typeof PartyAffiliationEnum[keyof typeof PartyAffiliationEnum];
export declare const PartyMethodsEnum: {
    readonly INVITEE: "Invitee";
    readonly ATTENDEE: "Attendee";
};
export type PartyMethodsEnum = typeof PartyMethodsEnum[keyof typeof PartyMethodsEnum];
