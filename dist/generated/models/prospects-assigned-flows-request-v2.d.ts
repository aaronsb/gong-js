 ...
 * @export
 * @interface ProspectsAssignedFlowsRequestV2
 */
export interface ProspectsAssignedFlowsRequestV2 {
    /**
     * The CRM IDs of the prospects to list assigned flows for
     * @type {Set<string>}
     * @memberof ProspectsAssignedFlowsRequestV2
     */
    'crmProspectsIds': Set<string>;
}
