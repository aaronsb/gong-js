 ...
 */
import type { ExternalPartyObject } from './external-party-object';
/**
 * Links to external systems such as CRM, Dialer, Case Management etc
 * @export
 * @interface PartyContextDto
 */
export interface PartyContextDto {
    /**
     * External system name. e.g. Salesforce
     * @type {string}
     * @memberof PartyContextDto
     */
    'system'?: PartyContextDtoSystemEnum;
    /**
     *  List of objects within the external system
     * @type {Array<ExternalPartyObject>}
     * @memberof PartyContextDto
     */
    'objects'?: Array<ExternalPartyObject>;
}
export declare const PartyContextDtoSystemEnum: {
    readonly SALESFORCE: "Salesforce";
    readonly HUB_SPOT: "HubSpot";
    readonly MICROSOFT_DYNAMIC: "MicrosoftDynamic";
    readonly GENERIC: "Generic";
};
export type PartyContextDtoSystemEnum = typeof PartyContextDtoSystemEnum[keyof typeof PartyContextDtoSystemEnum];
