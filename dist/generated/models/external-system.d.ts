 ...
 */
import type { ExternalSystemObject } from './external-system-object';
/**
...
export interface ExternalSystem {
     ...
     */
    'system'?: ExternalSystemSystemEnum;
    /**
     * List of objects within the external system.
     * @type {Array<ExternalSystemObject>}
     * @memberof ExternalSystem
     */
    'objects'?: Array<ExternalSystemObject>;
}
export declare const ExternalSystemSystemEnum: {
    readonly SALESFORCE: "Salesforce";
    readonly HUB_SPOT: "HubSpot";
    readonly MICROSOFT_DYNAMIC: "MicrosoftDynamic";
    readonly GENERIC: "Generic";
};
export type ExternalSystemSystemEnum = typeof ExternalSystemSystemEnum[keyof typeof ExternalSystemSystemEnum];
