 ...
 * @export
 * @interface CompanyBusinessContext
 */
export interface CompanyBusinessContext {
    /**
     * The object type in the external system
     * @type {string}
     * @memberof CompanyBusinessContext
     */
    'objectType': CompanyBusinessContextObjectTypeEnum;
    /**
...
export declare const CompanyBusinessContextObjectTypeEnum: {
    readonly ACCOUNT: "ACCOUNT";
    readonly OPPORTUNITY: "OPPORTUNITY";
};
export type CompanyBusinessContextObjectTypeEnum = typeof CompanyBusinessContextObjectTypeEnum[keyof typeof CompanyBusinessContextObjectTypeEnum];
