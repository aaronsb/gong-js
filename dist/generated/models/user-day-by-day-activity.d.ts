 ...
 */
import type { DailyActivityWithDates } from './daily-activity-with-dates';
/**
 * A list, in which each item contains one user\'s activity.
 * @export
 * @interface UserDayByDayActivity
 */
export interface UserDayByDayActivity {
    /**
     * Gong\'s unique numeric identifier for the user (up to 20 digits).
     * @type {string}
     * @memberof UserDayByDayActivity
     */
    'userId'?: string;
    /**
     ...
     * @type {Array<DailyActivityWithDates>}
     * @memberof UserDayByDayActivity
     */
    'userDailyActivityStats'?: Array<DailyActivityWithDates>;
}
