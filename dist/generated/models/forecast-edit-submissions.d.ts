 ...
 * @export
 * @interface ForecastEditSubmissions
 */
export interface ForecastEditSubmissions {
    /**
     * Permission access scope.
     * @type {string}
     * @memberof ForecastEditSubmissions
     */
    'permissionLevel'?: ForecastEditSubmissionsPermissionLevelEnum;
    /**
...
export declare const ForecastEditSubmissionsPermissionLevelEnum: {
    readonly ALL: "all";
...
export type ForecastEditSubmissionsPermissionLevelEnum = typeof ForecastEditSubmissionsPermissionLevelEnum[keyof typeof ForecastEditSubmissionsPermissionLevelEnum];
