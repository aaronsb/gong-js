 ...
 * @export
 * @interface ForecastEditTargets
 */
export interface ForecastEditTargets {
    /**
     * Permission access scope.
     * @type {string}
     * @memberof ForecastEditTargets
     */
    'permissionLevel'?: ForecastEditTargetsPermissionLevelEnum;
    /**
...
export declare const ForecastEditTargetsPermissionLevelEnum: {
    readonly ALL: "all";
...
export type ForecastEditTargetsPermissionLevelEnum = typeof ForecastEditTargetsPermissionLevelEnum[keyof typeof ForecastEditTargetsPermissionLevelEnum];
