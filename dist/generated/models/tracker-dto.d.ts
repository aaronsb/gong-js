...
import type { TrackerPhrases } from './tracker-phrases';
/**
 *
 * @export
...
export interface TrackerDto {
     ...
     * @type {Array<TrackerPhrases>}
     * @memberof TrackerDto
     */
    'phrases'?: Array<TrackerPhrases>;
}
export declare const TrackerDtoTypeEnum: {
    readonly KEYWORD: "KEYWORD";
    readonly SMART: "SMART";
};
export type TrackerDtoTypeEnum = typeof TrackerDtoTypeEnum[keyof typeof TrackerDtoTypeEnum];
