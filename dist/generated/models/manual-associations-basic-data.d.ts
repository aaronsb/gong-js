 ...
 */
import type { AssociationObject } from './association-object';
/**
 * Basic association details such as call Id, etc.
 * @export
 * @interface ManualAssociationsBasicData
 */
export interface ManualAssociationsBasicData {
    /**
     * Gong\'s unique numeric identifier for the call (up to 20 digits).
     * @type {string}
     * @memberof ManualAssociationsBasicData
     */
    'callId'?: string;
    /**
     ...
     * @type {Array<AssociationObject>}
     * @memberof ManualAssociationsBasicData
     */
    'associatedCrmObjects'?: Array<AssociationObject>;
}
