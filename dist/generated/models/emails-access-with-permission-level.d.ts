 ...
 * @export
 * @interface EmailsAccessWithPermissionLevel
 */
export interface EmailsAccessWithPermissionLevel {
    /**
     * Permission access scope.
     * @type {string}
     * @memberof EmailsAccessWithPermissionLevel
     */
    'permissionLevel'?: EmailsAccessWithPermissionLevelPermissionLevelEnum;
    /**
...
export declare const EmailsAccessWithPermissionLevelPermissionLevelEnum: {
    readonly ALL: "all";
...
export type EmailsAccessWithPermissionLevelPermissionLevelEnum = typeof EmailsAccessWithPermissionLevelPermissionLevelEnum[keyof typeof EmailsAccessWithPermissionLevelPermissionLevelEnum];
