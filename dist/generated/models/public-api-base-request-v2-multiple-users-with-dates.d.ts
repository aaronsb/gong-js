 ...
 *
 * @export
 * @interface PublicApiBaseRequestV2MultipleUsersWithDates
 */
export interface PublicApiBaseRequestV2MultipleUsersWithDates {
    /**
     * When paging is needed, provide the value supplied by the previous API call to bring the following page of records.
     * @type {string}
     * @memberof PublicApiBaseRequestV2MultipleUsersWithDates
     */
    'cursor'?: string;
    /**
     *
