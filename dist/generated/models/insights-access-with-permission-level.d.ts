 ...
 * @export
 * @interface InsightsAccessWithPermissionLevel
 */
export interface InsightsAccessWithPermissionLevel {
    /**
     * Permission access scope.
     * @type {string}
     * @memberof InsightsAccessWithPermissionLevel
     */
    'permissionLevel'?: InsightsAccessWithPermissionLevelPermissionLevelEnum;
    /**
...
export declare const InsightsAccessWithPermissionLevelPermissionLevelEnum: {
    readonly ALL: "all";
...
export type InsightsAccessWithPermissionLevelPermissionLevelEnum = typeof InsightsAccessWithPermissionLevelPermissionLevelEnum[keyof typeof InsightsAccessWithPermissionLevelPermissionLevelEnum];
