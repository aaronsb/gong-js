 ...
 * @export
 * @interface CallAccessWithPermissionLevel
 */
export interface CallAccessWithPermissionLevel {
    /**
     * Permission access scope.
     * @type {string}
     * @memberof CallAccessWithPermissionLevel
     */
    'permissionLevel'?: CallAccessWithPermissionLevelPermissionLevelEnum;
    /**
...
export declare const CallAccessWithPermissionLevelPermissionLevelEnum: {
    readonly ALL: "all";
...
export type CallAccessWithPermissionLevelPermissionLevelEnum = typeof CallAccessWithPermissionLevelPermissionLevelEnum[keyof typeof CallAccessWithPermissionLevelPermissionLevelEnum];
