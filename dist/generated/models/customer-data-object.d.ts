...
export interface CustomerDataObject {
     ...
     * @memberof CustomerDataObject
     */
    'objectType'?: CustomerDataObjectObjectTypeEnum;
    /**
     * External ID.
     * @type {string}
     * @memberof CustomerDataObject
...
export declare const CustomerDataObjectObjectTypeEnum: {
    readonly LEAD: "Lead";
    readonly CONTACT: "Contact";
};
export type CustomerDataObjectObjectTypeEnum = typeof CustomerDataObjectObjectTypeEnum[keyof typeof CustomerDataObjectObjectTypeEnum];
