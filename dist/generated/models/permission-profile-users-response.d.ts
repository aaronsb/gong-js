 ...
 */
import type { UserSimpleMetadata } from './user-simple-metadata';
/**
 *
 * @export
 * @interface PermissionProfileUsersResponse
 */
export interface PermissionProfileUsersResponse {
    /**
     * A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
     * @type {string}
     * @memberof PermissionProfileUsersResponse
     */
    'requestId'?: string;
    /**
     * A list, in which each item specifies a user attached to the permission profile.
     * @type {Array<UserSimpleMetadata>}
     * @memberof PermissionProfileUsersResponse
     */
    'users'?: Array<UserSimpleMetadata>;
}
