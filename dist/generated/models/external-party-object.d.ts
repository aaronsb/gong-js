 ...
 */
import type { PartyContextField } from './party-context-field';
/**
 * External Object
 * @export
 * @interface ExternalPartyObject
 */
export interface ExternalPartyObject {
    /**
     * Object Type. e.g. Lead
     * @type {string}
     * @memberof ExternalPartyObject
     */
    'objectType'?: ExternalPartyObjectObjectTypeEnum;
    /**
     * Object ID
     * @type {string}
     * @memberof ExternalPartyObject
    ...
    /**
     * Object fields
     * @type {Array<PartyContextField>}
     * @memberof ExternalPartyObject
     */
    'fields'?: Array<PartyContextField>;
    /**
     * Timing of object
     * @type {string}
     * @memberof ExternalPartyObject
     */
    'timing'?: ExternalPartyObjectTimingEnum;
}
export declare const ExternalPartyObjectObjectTypeEnum: {
    readonly CONTACT: "Contact";
    readonly USER: "User";
    readonly LEAD: "Lead";
};
export type ExternalPartyObjectObjectTypeEnum = typeof ExternalPartyObjectObjectTypeEnum[keyof typeof ExternalPartyObjectObjectTypeEnum];
export declare const ExternalPartyObjectTimingEnum: {
    readonly NOW: "Now";
    readonly TIME_OF_CALL: "TimeOfCall";
};
export type ExternalPartyObjectTimingEnum = typeof ExternalPartyObjectTimingEnum[keyof typeof ExternalPartyObjectTimingEnum];
