 ...
 */
import type { CrmPartyContextField } from './crm-party-context-field';
/**
 * External object associated with the party
 * @export
 * @interface ExternalCrmPartyObject
 */
export interface ExternalCrmPartyObject {
    /**
     * Object Type. Valid only for non-company parties. e.g. Lead.
     * @type {string}
     * @memberof ExternalCrmPartyObject
     */
    'objectType': ExternalCrmPartyObjectObjectTypeEnum;
    /**
     ...
     * @type {Array<CrmPartyContextField>}
     * @memberof ExternalCrmPartyObject
     */
    'fields'?: Array<CrmPartyContextField>;
}
export declare const ExternalCrmPartyObjectObjectTypeEnum: {
    readonly LEAD: "Lead";
    readonly CONTACT: "Contact";
    readonly ACCOUNT: "Account";
    readonly OPPORTUNITY: "Opportunity";
    readonly USER: "User";
    readonly LEAD_CONTACT: "Lead,Contact";
};
export type ExternalCrmPartyObjectObjectTypeEnum = typeof ExternalCrmPartyObjectObjectTypeEnum[keyof typeof ExternalCrmPartyObjectObjectTypeEnum];
