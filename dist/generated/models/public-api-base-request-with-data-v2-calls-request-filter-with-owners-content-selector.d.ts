 ...
 */
import type { CallsRequestFilterWithOwners } from './calls-request-filter-with-owners';
import type { ContentSelector } from './content-selector';
/**
 *
 * @export
 * @interface PublicApiBaseRequestWithDataV2CallsRequestFilterWithOwnersContentSelector
 */
export interface PublicApiBaseRequestWithDataV2CallsRequestFilterWithOwnersContentSelector {
    /**
     * When paging is needed, provide the value supplied by the previous API call to bring the following page of records.
     * @type {string}
     * @memberof PublicApiBaseRequestWithDataV2CallsRequestFilterWithOwnersContentSelector
     */
    'cursor'?: string;
    /**
     *
     * @type {CallsRequestFilterWithOwners}
     * @memberof PublicApiBaseRequestWithDataV2CallsRequestFilterWithOwnersContentSelector
     */
    'filter': CallsRequestFilterWithOwners;
    /**
     *
