 ...
 */
import type { IntegrationTypeSettings } from './integration-type-settings';
/**
 * Integration settings metadata
 * @export
 * @interface IntegrationSettingsRequest
 */
export interface IntegrationSettingsRequest {
    /**
     * Set a list of dynamic origins for a company
     * @type {Array<IntegrationTypeSettings>}
     * @memberof IntegrationSettingsRequest
     */
    'integrationTypeSettings': Array<IntegrationTypeSettings>;
}
