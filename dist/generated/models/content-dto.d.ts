 ...
 */
import type { CallHighlightsSection } from './call-highlights-section';
import type { CallKeyPoint } from './call-key-point';
import type { CallOutcome } from './call-outcome';
import type { CallOutlineSection } from './call-outline-section';
import type { PointsOfInterest } from './points-of-interest';
import type { StructureDto } from './structure-dto';
...
export interface ContentDto {
     ...
     * @memberof ContentDto
     */
    'structure'?: Array<StructureDto>;
    /**
     *
     * @type {Array<TrackerDto>}
     * @memberof ContentDto
     */
     ...
     * @type {Array<CallOutlineSection>}
     * @memberof ContentDto
     */
    'outline'?: Array<CallOutlineSection>;
    /**
     * List of highlights of the call. Returned when it is available and contentSelector.exposedFields.content.highlights = true.
     * @type {Array<CallHighlightsSection>}
     * @memberof ContentDto
     */
    'highlights'?: Array<CallHighlightsSection>;
    /**
     *
     * @type {CallOutcome}
     * @memberof ContentDto
     ...
     * @type {Array<CallKeyPoint>}
     * @memberof ContentDto
     */
    'keyPoints'?: Array<CallKeyPoint>;
}
