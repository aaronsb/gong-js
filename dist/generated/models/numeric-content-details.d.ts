 ...
 * @export
 * @interface NumericContentDetails
 */
export interface NumericContentDetails {
    /**
     * The numeric value for the content
     * @type {number}
     * @memberof NumericContentDetails
     */
    'value'?: number;
    /**
     ...
     * @memberof NumericContentDetails
     */
    'numericType'?: NumericContentDetailsNumericTypeEnum;
}
export declare const NumericContentDetailsNumericTypeEnum: {
    readonly PERCENTAGE: "PERCENTAGE";
    readonly NPS: "NPS";
    readonly RATING: "RATING";
    readonly OTHER: "OTHER";
};
export type NumericContentDetailsNumericTypeEnum = typeof NumericContentDetailsNumericTypeEnum[keyof typeof NumericContentDetailsNumericTypeEnum];
