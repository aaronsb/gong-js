...
export interface CustomerEngagement {
     ...
     */
    'eventType'?: CustomerEngagementEventTypeEnum;
    /**
...
export declare const CustomerEngagementEventTypeEnum: {
    readonly CONTENT_SHARED: "contentShared";
    readonly CONTENT_VIEWED: "contentViewed";
    readonly CUSTOM_EVENT: "customEvent";
    readonly DIGITAL_INTERACTION: "digitalInteraction";
};
export type CustomerEngagementEventTypeEnum = typeof CustomerEngagementEventTypeEnum[keyof typeof CustomerEngagementEventTypeEnum];
