 ...
 *
 * @export
 * @interface AssignedFlowFailure
 */
export interface AssignedFlowFailure {
    /**
     * The flow ID to which the assignment failed
     * @type {string}
     * @memberof AssignedFlowFailure
     */
    'flowId'?: string;
    /**
     ...
     * @memberof AssignedFlowFailure
     */
    'errorCode'?: AssignedFlowFailureErrorCodeEnum;
    /**
...
export declare const AssignedFlowFailureErrorCodeEnum: {
    readonly INVALID_ARGUMENT: "InvalidArgument";
    readonly INVALID_STATE: "InvalidState";
    readonly UNEXPECTED_ERROR: "UnexpectedError";
};
export type AssignedFlowFailureErrorCodeEnum = typeof AssignedFlowFailureErrorCodeEnum[keyof typeof AssignedFlowFailureErrorCodeEnum];
