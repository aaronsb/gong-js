...
import type { GenericProperty } from './generic-property';
import type { Sharer } from './sharer';
/**
 * Content Viewed event
 * @export
 * @interface ContentViewedEvent
 */
export interface ContentViewedEvent {
     ...
     * @memberof ContentViewedEvent
     */
    'crmContext'?: Array<CallUploadContext>;
    /**
     * A list of additional properties for the content
     * @type {Array<GenericProperty>}
     * @memberof ContentViewedEvent
     */
    'contentProperties'?: Array<GenericProperty>;
    /**
     * A list of additional properties for the event
     * @type {Array<GenericProperty>}
     * @memberof ContentViewedEvent
     */
    'eventProperties'?: Array<GenericProperty>;
    /**
     ...
     * @memberof ContentViewedEvent
     */
    'agentPlatform'?: ContentViewedEventAgentPlatformEnum;
    /**
     ...
     * @memberof ContentViewedEvent
     */
    'nonCompanyParticipants'?: Array<Actor>;
    /**
     *
     * @type {string}
     * @memberof ContentViewedEvent
...
export declare const ContentViewedEventAgentPlatformEnum: {
    readonly WINDOWS_LINUX_MAC_OS_I_OS_ANDROID: "Windows, Linux, MacOS, iOS, Android";
};
export type ContentViewedEventAgentPlatformEnum = typeof ContentViewedEventAgentPlatformEnum[keyof typeof ContentViewedEventAgentPlatformEnum];
