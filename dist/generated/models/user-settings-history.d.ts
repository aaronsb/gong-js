 ...
 * @export
 * @interface UserSettingsHistory
 */
export interface UserSettingsHistory {
    /**
     * The user capability that was changed
     * @type {string}
     * @memberof UserSettingsHistory
     */
    'setting'?: UserSettingsHistorySettingEnum;
    /**
...
export declare const UserSettingsHistorySettingEnum: {
    readonly WEB_CONFERENCES_RECORDED: "webConferencesRecorded";
    readonly PREVENT_WEB_CONFERENCE_RECORDING: "preventWebConferenceRecording";
    readonly EMAILS_IMPORTED: "emailsImported";
    readonly PREVENT_EMAIL_IMPORT: "preventEmailImport";
    readonly ACTIVE: "active";
    readonly NON_RECORDED_MEETINGS_IMPORTED: "nonRecordedMeetingsImported";
    readonly GONG_CONNECT_ENABLED: "gongConnectEnabled";
    readonly CALLS_IMPORTED: "callsImported";
    readonly INTERVIEWS_RECORDED: "interviewsRecorded";
    readonly PREVENT_INTERVIEW_RECORDING: "preventInterviewRecording";
};
export type UserSettingsHistorySettingEnum = typeof UserSettingsHistorySettingEnum[keyof typeof UserSettingsHistorySettingEnum];
