 ...
 * @export
 * @interface IntegrationTypeSettings
 */
export interface IntegrationTypeSettings {
    /**
     * The integration type in Gong
     * @type {string}
     * @memberof IntegrationTypeSettings
     */
    'integrationType': IntegrationTypeSettingsIntegrationTypeEnum;
    /**
...
export declare const IntegrationTypeSettingsIntegrationTypeEnum: {
    readonly EMAIL_COMPOSER: "EMAIL_COMPOSER";
    readonly ACCOUNT_PAGES: "ACCOUNT_PAGES";
    readonly DIALER: "DIALER";
};
export type IntegrationTypeSettingsIntegrationTypeEnum = typeof IntegrationTypeSettingsIntegrationTypeEnum[keyof typeof IntegrationTypeSettingsIntegrationTypeEnum];
