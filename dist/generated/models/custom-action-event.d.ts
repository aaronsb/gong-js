...
export interface CustomActionEvent {
     ...
     * @memberof CustomActionEvent
     */
    'agentPlatform'?: CustomActionEventAgentPlatformEnum;
    /**
...
export declare const CustomActionEventAgentPlatformEnum: {
    readonly WINDOWS_LINUX_MAC_OS_I_OS_ANDROID: "Windows, Linux, MacOS, iOS, Android";
};
export type CustomActionEventAgentPlatformEnum = typeof CustomActionEventAgentPlatformEnum[keyof typeof CustomActionEventAgentPlatformEnum];
