 ...
 */
import type { ExternalCrmCallObject } from './external-crm-call-object';
/**
 ...
 * @export
 * @interface CallUploadContext
 */
export interface CallUploadContext {
    /**
     * External system name. Currently only Salesforce and Generic are supported.
     * @type {string}
     * @memberof CallUploadContext
     */
    'system': CallUploadContextSystemEnum;
    /**
     ...
     * @type {Array<ExternalCrmCallObject>}
     * @memberof CallUploadContext
     */
    'objects'?: Array<ExternalCrmCallObject>;
}
export declare const CallUploadContextSystemEnum: {
    readonly SALESFORCE: "Salesforce";
    readonly HUB_SPOT: "HubSpot";
    readonly MICROSOFT_DYNAMIC: "MicrosoftDynamic";
    readonly GENERIC: "Generic";
};
export type CallUploadContextSystemEnum = typeof CallUploadContextSystemEnum[keyof typeof CallUploadContextSystemEnum];
