 ...
 * @export
 * @interface ExternalSystemObject
 */
export interface ExternalSystemObject {
    /**
     * Object Type.
     * @type {string}
     * @memberof ExternalSystemObject
     */
    'objectType'?: ExternalSystemObjectObjectTypeEnum;
    /**
     * External ID.
     * @type {string}
     * @memberof ExternalSystemObject
...
export declare const ExternalSystemObjectObjectTypeEnum: {
    readonly CONVERSATION: "Conversation";
    readonly TASK: "Task";
};
export type ExternalSystemObjectObjectTypeEnum = typeof ExternalSystemObjectObjectTypeEnum[keyof typeof ExternalSystemObjectObjectTypeEnum];
