 ...
 */
import type { CallUsersAccessDto } from './call-users-access-dto';
/**
 *
 * @export
 * @interface CallsUsersAccessDeleteDto
 */
export interface CallsUsersAccessDeleteDto {
    /**
     * A list, in which each item specifies a call and a list of users to be removed from the call.
     * @type {Array<CallUsersAccessDto>}
     * @memberof CallsUsersAccessDeleteDto
     */
    'callAccessList'?: Array<CallUsersAccessDto>;
}
