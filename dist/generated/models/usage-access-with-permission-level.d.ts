 ...
 * @export
 * @interface UsageAccessWithPermissionLevel
 */
export interface UsageAccessWithPermissionLevel {
    /**
     * Permission access scope.
     * @type {string}
     * @memberof UsageAccessWithPermissionLevel
     */
    'permissionLevel'?: UsageAccessWithPermissionLevelPermissionLevelEnum;
    /**
...
export declare const UsageAccessWithPermissionLevelPermissionLevelEnum: {
    readonly ALL: "all";
...
export type UsageAccessWithPermissionLevelPermissionLevelEnum = typeof UsageAccessWithPermissionLevelPermissionLevelEnum[keyof typeof UsageAccessWithPermissionLevelPermissionLevelEnum];
