 ...
 * @export
 * @interface ExternalCrmCallObject
 */
export interface ExternalCrmCallObject {
    /**
     * Object Type. e.g. Account.
     * @type {string}
     * @memberof ExternalCrmCallObject
     */
    'objectType': ExternalCrmCallObjectObjectTypeEnum;
    /**
...
export declare const ExternalCrmCallObjectObjectTypeEnum: {
    readonly OPPORTUNITY: "Opportunity";
    readonly ACCOUNT: "Account";
    readonly LEAD: "Lead";
    readonly CONTACT: "Contact";
    readonly USER: "User";
    readonly OPPORTUNITY_ACCOUNT: "Opportunity,Account";
};
export type ExternalCrmCallObjectObjectTypeEnum = typeof ExternalCrmCallObjectObjectTypeEnum[keyof typeof ExternalCrmCallObjectObjectTypeEnum];
