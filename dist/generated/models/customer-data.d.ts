 ...
 */
import type { CustomerDataObject } from './customer-data-object';
/**
...
export interface CustomerData {
     ...
     */
    'system'?: CustomerDataSystemEnum;
    /**
     * List of objects in the external system.
     * @type {Array<CustomerDataObject>}
     * @memberof CustomerData
     */
    'objects'?: Array<CustomerDataObject>;
}
export declare const CustomerDataSystemEnum: {
    readonly SALESFORCE: "Salesforce";
    readonly HUB_SPOT: "HubSpot";
    readonly MICROSOFT_DYNAMIC: "MicrosoftDynamic";
    readonly GENERIC: "Generic";
};
export type CustomerDataSystemEnum = typeof CustomerDataSystemEnum[keyof typeof CustomerDataSystemEnum];
