 ...
 */
import type { ContextField } from './context-field';
/**
 * External Object
 * @export
 * @interface ExternalCallObject
 */
export interface ExternalCallObject {
    /**
     * Object Type. e.g Opportunity.
     * @type {string}
     * @memberof ExternalCallObject
     */
    'objectType'?: ExternalCallObjectObjectTypeEnum;
    /**
     * Object ID
     * @type {string}
     * @memberof ExternalCallObject
     ...
     * @memberof ExternalCallObject
     */
    'timing'?: ExternalCallObjectTimingEnum;
}
export declare const ExternalCallObjectObjectTypeEnum: {
    readonly OPPORTUNITY: "Opportunity";
    readonly ACCOUNT: "Account";
};
export type ExternalCallObjectObjectTypeEnum = typeof ExternalCallObjectObjectTypeEnum[keyof typeof ExternalCallObjectObjectTypeEnum];
export declare const ExternalCallObjectTimingEnum: {
    readonly NOW: "Now";
    readonly TIME_OF_CALL: "TimeOfCall";
};
export type ExternalCallObjectTimingEnum = typeof ExternalCallObjectTimingEnum[keyof typeof ExternalCallObjectTimingEnum];
