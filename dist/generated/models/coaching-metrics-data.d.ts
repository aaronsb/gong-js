 ...
 */
import type { CoachingRepData } from './coaching-rep-data';
import type { CoachingUser } from './coaching-user';
/**
 * A list, in which each item specifies one managers coaching data
 * @export
 * @interface CoachingMetricsData
 */
export interface CoachingMetricsData {
    /**
     *
     * @type {CoachingUser}
     * @memberof CoachingMetricsData
     */
    'manager'?: CoachingUser;
    /**
     *
     * @type {Array<CoachingRepData>}
     * @memberof CoachingMetricsData
     */
    'directReportsMetrics'?: Array<CoachingRepData>;
}
