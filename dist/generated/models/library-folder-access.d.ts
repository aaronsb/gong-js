...
export declare const LibraryFolderAccessPermissionLevelEnum: {
    readonly NONE: "none";
    readonly ALL: "all";
    readonly SPECIFIC_FOLDERS: "specific-folders";
    readonly NONE_ALL_SPECIFIC_FOLDERS: "none, all, specific-folders";
};
export type LibraryFolderAccessPermissionLevelEnum = typeof LibraryFolderAccessPermissionLevelEnum[keyof typeof LibraryFolderAccessPermissionLevelEnum];
