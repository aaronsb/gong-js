 ...
 */
import type { UserIntegrationStatus } from './user-integration-status';
/**
 *
 * @export
...
export interface IntegrationStatusResponse {
     ...
     * @type {string}
     * @memberof IntegrationStatusResponse
     */
    'requestId'?: string;
    /**
     * The integration status for the request users
     * @type {Array<UserIntegrationStatus>}
     * @memberof IntegrationStatusResponse
     */
    'users'?: Array<UserIntegrationStatus>;
}
