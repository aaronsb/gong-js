 ...
 */
import type { LineErrorResponse } from './line-error-response';
/**
 *
 * @export
...
export interface RequestStatusResponse {
     ...
     * @memberof RequestStatusResponse
     */
    'status'?: RequestStatusResponseStatusEnum;
    /**
     *
     * @type {Array<LineErrorResponse>}
     * @memberof RequestStatusResponse
     */
    'errors'?: Array<LineErrorResponse>;
    /**
...
export declare const RequestStatusResponseStatusEnum: {
    readonly PENDING: "PENDING";
    readonly IN_PROGRESS: "IN_PROGRESS";
    readonly DONE: "DONE";
    readonly FAILED: "FAILED";
};
export type RequestStatusResponseStatusEnum = typeof RequestStatusResponseStatusEnum[keyof typeof RequestStatusResponseStatusEnum];
