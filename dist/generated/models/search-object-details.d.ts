 ...
 * @export
 * @interface SearchObjectDetails
 */
export interface SearchObjectDetails {
    /**
     * The name of the entity the person searched for
     * @type {string}
     * @memberof SearchObjectDetails
     */
    'name': string;
    /**
     ...
     * @memberof SearchObjectDetails
     */
    'objectType': SearchObjectDetailsObjectTypeEnum;
    /**
...
export declare const SearchObjectDetailsObjectTypeEnum: {
    readonly VENDOR: "VENDOR";
    readonly PRODUCT: "PRODUCT";
    readonly CATEGORY: "CATEGORY";
};
export type SearchObjectDetailsObjectTypeEnum = typeof SearchObjectDetailsObjectTypeEnum[keyof typeof SearchObjectDetailsObjectTypeEnum];
