 ...
 */
import type { GenericCrmIntegration } from './generic-crm-integration';
/**
 *
 * @export
 * @interface ListGenericCrmIntegrationsResponse
 */
export interface ListGenericCrmIntegrationsResponse {
    /**
     * A Gong request reference Id, generated for this request. Can be used for troubleshooting purposes.
     * @type {string}
     * @memberof ListGenericCrmIntegrationsResponse
     */
    'requestId'?: string;
    /**
     * A list of integration objects
     * @type {Array<GenericCrmIntegration>}
     * @memberof ListGenericCrmIntegrationsResponse
     */
    'integrations'?: Array<GenericCrmIntegration>;
}
