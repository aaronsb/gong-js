 ...
 */
import type { CallHighlightsItem } from './call-highlights-item';
/**
 *
 * @export
 * @interface CallHighlightsSection
 */
export interface CallHighlightsSection {
    /**
     * The title of the highlights section.
     * @type {string}
     * @memberof CallHighlightsSection
     */
    'title'?: string;
    /**
     * List of highlight items of the call in this section.
     * @type {Array<CallHighlightsItem>}
     * @memberof CallHighlightsSection
     */
    'items'?: Array<CallHighlightsItem>;
}
