 ...
 */
import type { ForecastAccess } from './forecast-access';
import type { ForecastEditSubmissions } from './forecast-edit-submissions';
import type { ForecastEditTargets } from './forecast-edit-targets';
/**
 * All forecast permissions.
 * @export
 * @interface ForecastPermissions
 */
export interface ForecastPermissions {
    /**
     *
     * @type {ForecastAccess}
     * @memberof ForecastPermissions
     */
    'forecastAccess'?: ForecastAccess;
    /**
     *
     * @type {ForecastEditSubmissions}
     * @memberof ForecastPermissions
     */
    'forecastEditSubmissions'?: ForecastEditSubmissions;
    /**
     *
     * @type {ForecastEditTargets}
     * @memberof ForecastPermissions
     */
    'forecastEditTargets'?: ForecastEditTargets;
}
