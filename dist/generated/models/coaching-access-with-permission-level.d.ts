 ...
 * @export
 * @interface CoachingAccessWithPermissionLevel
 */
export interface CoachingAccessWithPermissionLevel {
    /**
     * Permission access scope.
     * @type {string}
     * @memberof CoachingAccessWithPermissionLevel
     */
    'permissionLevel'?: CoachingAccessWithPermissionLevelPermissionLevelEnum;
    /**
...
export declare const CoachingAccessWithPermissionLevelPermissionLevelEnum: {
    readonly ALL: "all";
    readonly MANAGERS_TEAM: "managers-team";
    readonly REPORT_TO_THEM: "report-to-them";
    readonly OWN: "own";
    readonly NONE: "none";
    readonly ALL___MANAGERS_TEAM___REPORT_TO_THEM___OWN___NONE: "all / managers-team / report-to-them / own / none";
};
export type CoachingAccessWithPermissionLevelPermissionLevelEnum = typeof CoachingAccessWithPermissionLevelPermissionLevelEnum[keyof typeof CoachingAccessWithPermissionLevelPermissionLevelEnum];
