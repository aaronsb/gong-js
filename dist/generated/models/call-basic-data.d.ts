...
export interface CallBasicData {
     ...
     * @memberof CallBasicData
     */
    'direction'?: CallBasicDataDirectionEnum;
    /**
     ...
     * @memberof CallBasicData
     */
    'scope'?: CallBasicDataScopeEnum;
    /**
     * Media type
     * @type {string}
     * @memberof CallBasicData
     */
    'media'?: CallBasicDataMediaEnum;
    /**
...
export declare const CallBasicDataDirectionEnum: {
    readonly INBOUND: "Inbound";
    readonly OUTBOUND: "Outbound";
    readonly CONFERENCE: "Conference";
    readonly UNKNOWN: "Unknown";
};
export type CallBasicDataDirectionEnum = typeof CallBasicDataDirectionEnum[keyof typeof CallBasicDataDirectionEnum];
export declare const CallBasicDataScopeEnum: {
    readonly INTERNAL: "Internal";
    readonly EXTERNAL: "External";
    readonly UNKNOWN: "Unknown";
};
export type CallBasicDataScopeEnum = typeof CallBasicDataScopeEnum[keyof typeof CallBasicDataScopeEnum];
export declare const CallBasicDataMediaEnum: {
    readonly VIDEO: "Video";
    readonly AUDIO: "Audio";
};
export type CallBasicDataMediaEnum = typeof CallBasicDataMediaEnum[keyof typeof CallBasicDataMediaEnum];
