 ...
 */
import type { ExternalCallObject } from './external-call-object';
/**
 * Links to external systems such as CRM, Dialer, Case Management etc
 * @export
 * @interface CallContextDto
 */
export interface CallContextDto {
    /**
     * External system name. e.g. Salesforce
     * @type {string}
     * @memberof CallContextDto
     */
    'system'?: CallContextDtoSystemEnum;
    /**
     * List of objects within the external system
     * @type {Array<ExternalCallObject>}
     * @memberof CallContextDto
     */
    'objects'?: Array<ExternalCallObject>;
}
export declare const CallContextDtoSystemEnum: {
    readonly SALESFORCE: "Salesforce";
    readonly HUB_SPOT: "HubSpot";
    readonly MICROSOFT_DYNAMIC: "MicrosoftDynamic";
    readonly GENERIC: "Generic";
};
export type CallContextDtoSystemEnum = typeof CallContextDtoSystemEnum[keyof typeof CallContextDtoSystemEnum];
